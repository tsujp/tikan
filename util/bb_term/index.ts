...
function print_bb (
    ...
    const f_file_lead = ' '.repeat(idnt_pre + idnt_to_rank + idnt_from_rank + idnt_tab + 2)
...
// print_bb(ROOK__BLOCK_4, true, '.')
//
const ROOK__SCENARIO_3 = board([
    '0x100030000000',
    '0x1010000025001000',
    '0x100020000000',
    '0',
